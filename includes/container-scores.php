    ...
    <div class="row text-center">
        <div class="col-xxl-12 d-flex p-1 justify-content-between">
            ...
            <div class="container container-scores-joueur1 p-1" id="joueur1">
                <div class="row">
                    <div class="col mb-1">
                        <span class="titre-joueur1 text-Shadow text-center text-white p-1">Joueur 1</span>
                    </div>
                </div>
                <div class="container">
                    <div class="row">
            ...
            <div class="container container-scores-joueur2 p-1" id="joueur2">
                <div class="row">
                    <div class="col mb-1">
                        <span class="titre-joueur2 text-Shadow text-center text-white p-1">Joueur 2</span>
                    </div>
                </div>
                <div class="container">
                    <div class="row">
